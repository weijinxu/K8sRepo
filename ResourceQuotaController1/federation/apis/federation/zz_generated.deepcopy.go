...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_federation_ClusterResourceQuotaSetPreferences, InType: reflect.TypeOf(&ClusterResourceQuotaSetPreferences{})},
...
func DeepCopy_federation_ClusterResourceQuotaSetPreferences(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ClusterResourceQuotaSetPreferences)
		out := out.(*ClusterResourceQuotaSetPreferences)
		out.MinReplicas = in.MinReplicas
		if in.MaxReplicas != nil {
			in, out := &in.MaxReplicas, &out.MaxReplicas
			*out = new(int64)
